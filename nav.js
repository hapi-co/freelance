...
// Call the function
  ...
  // Fixed Nav - Show when footer out of view
  // Mobile + icon hide when footer is visible
  const observerFooter = new IntersectionObserver(entries => {
    entries.forEach(entry => {
      if (entry.isIntersecting) {
        console.log("footer intersecting");
      } else {
        console.log("footer NOT intersecting");
        navFixed.style.display = "flex";
        navFixed.classList.add("navFixedHide");
        navFixed.classList.remove("navFixedAnimIn");
        navLogo.classList.add("navLogoAnimIn");
        navLogo.classList.remove("navLogoAnimOut");
        scrollBlock.classList.add("hide");
  ...
  observerFooter.observe(document.getElementById("contact"));
